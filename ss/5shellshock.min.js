...
window.jeff.modMenu.crosshairMod.updateCrosshair = function(type) {
  ...
  if (type == "White Hollow Circle") {
    ...
    y.style.cssText = `width:9px;height:8px;border-color:#000000;border-style:solid;border-width:5px;position:absolute;margin:auto;top:0;right:0;bottom:0;left:0;z-index:200;border-radius:100px`;
    z.style.cssText = `width:8px;height:9px;border-color:#FFFFFF;border-style:solid;border-width:3px;position:absolute;margin:auto;top:0;right:0;bottom:0;left:0;z-index:200;border-radius:100px`;
