...
window.jeff.loadGui = function(){
  ...
  jeff.modMenu.color.container.label = jeff.gui.Register({
    type: 'folder',
    label: 'Colors',
    open: false
  });

  jeff.modMenu.color.container.resetSettings = jeff.gui.Register({
    type: 'button',
    label: 'Unlock All',
    folder: 'Skins',
    action: function(){
      window.jeff.modMenu.color.unlockAll();
    }
  });
...
window.jeff.modMenu.color.unlockAll = function() {
