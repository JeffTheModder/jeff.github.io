/* VERSION: 0.40.0 TO MATCH
   VERSION: 1.2.1 */

// https://github.com/Elspex/Shellshock.ioHack Mowu#1167 https://discord.gg/CygjGYPv8X LMFAO
...
window.jeff = {
  ...
  modMenu: { 
    ...
    crosshairMod: {
      type: "None", // Options: None, White Cross, Black Cross, White Circle, Black Circle, White Square, Black Square
      updateCrosshair: ()=>{},
      container: {
        label: {}
      },
...
window.jeff.loadGui = function(){
  ...
  jeff.modMenu.giveVip.container.label = jeff.gui.Register({
    type: 'folder',
    label: 'Get VIP',
    open: false
  });

  jeff.modMenu.giveVip.container.resetSettings = jeff.gui.Register({
    type: 'button',
    label: 'Unlock',
    folder: 'Get VIP',
    action: function(){
      window.jeff.modMenu.giveVip.unlock();
    }
  });

  jeff.modMenu.crosshairMod.container.label = jeff.gui.Register({
    type: "folder",
    label: "Custom Crosshair",
    open: false,
  });

  jeff.modMenu.crosshairMod.container.resetSettings = jeff.gui.Register({
    type: "select",
    label: "Types",
    object: jeff.modMenu.crosshairMod,
    property: "type",
    folder: "Custom Crosshair",
    options: [
      "None",
      "Red Cross",
      "Red Circle",
    ...
    onChange: function(type) {
     window.jeff.modMenu.crosshairMod.updateCrosshair(type);
    }
  });
  ...
  window.jeff.modMenu.credit.container.innerHTML = `<p style="color:black;font-size: medium;margin-bottom: 0px;padding-left: 15px;">Mod Developed by Jeff</br>Thanks to RaidTheWeb for Teaching Me Everything I Know and Big Thanks to the 5514 Modding Team for Being My Inspiration</p>`
...
window.jeff.modMenu.giveVip.unlock = function() {
...
window.jeff.modMenu.crosshairMod.updateCrosshair = function(type) {
  if (type == "None") {
  ...
  if (type == "White Hollow Circle") {
    let y = document.getElementById("crossY");
    let z = document.getElementById("crossZ");
    let w = document.getElementById("crossW");
    let x = document.getElementById("crossX");

    y.style.cssText = `width:17px;height:17px;border-color:#000000;border-style:solid;border-width:5px;position:absolute;margin:auto;top:0;right:0;bottom:0;left:0;z-index:200;border-radius:100px`;
    z.style.cssText = `width:16px;height:16px;border-color:#FFFFFF;border-style:solid;border-width:3px;position:absolute;margin:auto;top:0;right:0;bottom:0;left:0;z-index:200;border-radius:100px`;
    w.style.cssText = `width:0px;height:1px;background-color:#FFFFFF;position:absolute;margin:auto;top:0;right:0;bottom:0;left:0;z-index:200;border-radius:0px`;
    x.style.cssText = `width:0px;height:1px;background-color:#FFFFFF;position:absolute;margin:auto;top:0;right:0;bottom:0;left:0;z-index:200;border-radius:0px`;
  }
}
