...
window.jeff.loadGui = function(){
  ...
  jeff.ModMenu.crosshairMod.container.resetSettings = jeff.gui.Register({
    type: "select",
    label: "Types",
    object: window.jeff.modMenu.crosshairMod,
    property: "type",
    ...
    options: [
      ...
      "Purple Circle",
      "Purple Square",
      "Purple Long Width",/* VERSION: 0.39.7 TO MATCH
   VERSION: 0.2.0 */
   ...
   window.jeff.loadGui = function(){
     ...
     jeff.ModMenu.crosshairMod.container.resetSettings = jeff.gui.Register({
       ...
       onChange: window.jeff.modMenu.crosshairMod.updateCrosshair(),
     });
